...
<head>
	...
	<meta property="og:url" content="http://steamsale.co.kr/apps/${type}/${PagingInfo.currIdx}" />
...
<body>
    ...
    <div class="text-center">
        <ul class="pagination">
        	...
        	<li><a href="/apps/${type}/1"><<</a></li>
        	</c:if>
        	<c:if test="${PagingInfo.currIdx ne PagingInfo.beforeIdx}">
            <li><a href="/apps/${type}/${PagingInfo.beforeIdx}"><</a></li>
            </c:if>
            ...
            <c:choose>
	            ...
	            <a href="/apps/${type}/${(expiry * 5) + status.index}">${(expiry * 5) + status.index}</a>
            </li>
            </c:if>
            </c:forEach>
            <c:if test="${PagingInfo.currIdx ne PagingInfo.nextIdx}">
            <li><a href="/apps/${type}/${PagingInfo.nextIdx}">></a></li>
            </c:if>
            <c:if test="${(expiry * 5) + 5 < finish}">
            <li><a href="/apps/${type}/${finish}">>></a></li>
            </c:if>
        </ul>                                                            
    </div>
    </c:if>
	...
	<script type="text/javascript">
	    jQuery(document).ready(function() {
	        ...
	        $('#lGame').addClass("active");
	        $('#apps${type}').addClass("active");
		});
